...
import com.example.helloworld.services.Common.parseNotifications
...
//        println("taskID: $taskID")
        ...
        var notifications = parseNotifications(result)
        val notificationID = notifications?.get("0f7e7da72cf3d1b5ba6807f05a8f4cba3cfe3426d88c310c8e4b2794a18b5b6e")
